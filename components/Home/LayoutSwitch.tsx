...
export default function LayoutSwitch({
  ...
  return (
    <button
      ...
      className={cn(
        "relative flex h-10 w-24 items-center rounded-lg p-1 shadow-sm transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-primary",
